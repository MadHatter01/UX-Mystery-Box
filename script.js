const prompts = [
  ...
  function generatePrompt() {
    ...
    document.getElementById('promptBox').innerHTML = `
      <p><strong>Product:</strong> ${randomPrompt.product}</p>
      <p><strong>Audience:</strong> ${randomPrompt.audience}</p>
      <p><strong>Twist:</strong> ${randomPrompt.twist}</p>
    `;
    
    document.getElementById('viewConstraints').classList.remove('hidden');
  }
  
  function viewConstraints() {
    document.getElementById('promptScreen').classList.add('hidden');
    
    document.getElementById('constraintScreen').classList.remove('hidden');
  ...
  function generateConstraint() {
    ...
    document.getElementById('constraintBox').innerHTML = `<p>${randomConstraint}</p>`;
    
    document.getElementById('newConstraint').classList.remove('hidden');
  }
